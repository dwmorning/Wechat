...
app.get('/get',function(req,res){
    ...
    connection.query(`SELECT *  FROM plan where Province ='${Province}'  and Batch='${Batch}' and Division='${Division}'`, (error, results, fields) => {
...
var server = app.listen(8003, function(){//监听3000端口
